...
urlpatterns = [
    ...
    path('storage/theme/<int:theme>', open_user_theme, name="open_theme"),
    path('storage/theme/<int:theme>/card/<int:card>', open_user_card, name="open_card"),
    path('storage/card/<int:card>', open_user_card, name="open_card"),
